...
import re
print("".join(re.findall("[A-Za-z]", ocr)))

# Challange 4
print ("\n \n Challange 4")

equality = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
