...
' Notes: Goods Movements are indexed. 
'session.findById("wnd[0]/usr/subTABLE:SAPLCOWB:0500/tblSAPLCOWBTCTRL_0500/txtCOWB_COMP-ERFMG[2,2]")



session.findById("wnd[0]").maximize
'This is the batch determination bit I think
...
session.findById("wnd[0]/tbar[1]/btn[18]").press    ' Goods Movement '
session.findById("wnd[0]").sendVKey 0    ' Enter key
session.findById("wnd[0]").sendVKey 0    ' Enter key
session.findById("wnd[0]").sendVKey 0    ' Enter key
